# Graph Report - AniFlux  (2026-05-04)

## Corpus Check
- 60 files · ~437,013 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 587 nodes · 685 edges · 21 communities detected
...
2. `package:firebase_auth/firebase_auth.dart` - 15 edges
3. `package:ainme_vault/theme/app_theme.dart` - 14 edges
...
Cohesion: 0.04
Nodes (42): package:ainme_vault/main.dart, package:ainme_vault/screens/login_screen.dart, package:firebase_auth/firebase_auth.dart, package:flutter/gestures.dart, package:flutter/material.dart, AuthWrapper, build, LoginScreen (+34 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (43): dart:math, package:ainme_vault/services/app_update_service.dart, AnimatedContainer, AnimatedSwitcher, _AnimeCard, BoxConstraints, build, _buildCarouselError (+35 more)
...
Cohesion: 0.06
Nodes (31): dart:io, package:cloud_firestore/cloud_firestore.dart, package:firebase_messaging/firebase_messaging.dart, package:flutter/services.dart, _listenForTokenRefresh, NotificationService, _requestPermission, _saveToken (+23 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (31): package:ainme_vault/providers/theme_provider.dart, package:graphql_flutter/graphql_flutter.dart, package:shared_preferences/shared_preferences.dart, AniListService, characters, client, description, invalidateAdultContentCache (+23 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (30): dart:ui, firebase_options.dart, package:firebase_core/firebase_core.dart, package:flutter_displaymode/flutter_displaymode.dart, package:flutter/foundation.dart, screens/home_screen.dart, screens/profile_screen.dart, screens/search_screen.dart (+22 more)
...
Cohesion: 0.09
Nodes (21): package:ainme_vault/services/anilist_service.dart, package:intl/intl.dart, AnimeEntryBottomSheet, _AnimeEntryBottomSheetState, build, _buildDateSelector, _buildSectionTitle, Container (+13 more)
...
## Knowledge Gaps
- **441 isolated node(s):** `-registerWithRegistry`, `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.`, `MainActivity`, `DefaultFirebaseOptions`, `UnsupportedError` (+436 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 15`** (7 nodes): `AppDelegate`, `.application()`, `.applicationShouldTerminateAfterLastWindowClosed()`, `.applicationSupportsSecureRestorableState()`, `FlutterAppDelegate`, `AppDelegate.swift`, `AppDelegate.swift`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 17`** (5 nodes): `RunnerTests.swift`, `RunnerTests.swift`, `RunnerTests`, `.testExample()`, `XCTestCase`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 18`** (5 nodes): `GeneratedPluginRegistrant.java`, `GeneratedPluginRegistrant`, `.registerWith()`, `-registerWithRegistry`, `GeneratedPluginRegistrant.m`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (4 nodes): `handle_new_rx_page()`, `__lldb_init_module()`, `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.`, `flutter_lldb_helper.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (2 nodes): `MainActivity.kt`, `MainActivity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `package:flutter/material.dart` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`?**
  _High betweenness centrality (0.279) - this node is a cross-community bridge._
- **Why does `package:flutter/services.dart` connect `Community 7` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 9`, `Community 11`, `Community 12`, `Community 13`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `package:ainme_vault/theme/app_theme.dart` connect `Community 11` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`?**
